...
|----|----|---|---|
| **Objekt/Teilnehmer** | Rechteck am oberen Rand | Repräsentiert ein Objekt, eine Systemkomponente oder einen Akteur | <img src="../grafiken/seq-leg-1.svg" width="170" alt="Objekt, Lebenslinie und Aktivierungsbalken"> |
...
| **Synchrone Nachricht** | Pfeil mit gefüllter Spitze (`->`) | Sender wartet auf Antwort (blockierend) | <img src="../grafiken/seq-leg-2.svg" width="170" alt="Synchrone, asynchrone und Rückgabenachricht"> |
...
| **Selbstaufruf** | Pfeil zur eigenen Lebenslinie | Objekt ruft eigene Methode auf | <img src="../grafiken/seq-leg-3.svg" width="150" alt="Selbstaufruf mit verschachteltem Aktivierungsbalken"> |
| **Objekterzeugung** | Pfeil mit `<<create>>` | Erzeugt ein neues Objekt | <img src="../grafiken/seq-leg-4.svg" width="170" alt="Objekterzeugung und Objektzerstörung"> |
| **Objektzerstörung** | Großes X am Ende der Lebenslinie | Objekt wird zerstört | siehe oben |
| **Fragment (alt)** | Box mit "alt" | if-else-Verzweigung | <img src="../grafiken/seq-leg-5.svg" width="200" alt="Fragmente loop, opt und alt"> |
...
<div style="text-align: center;"><img src="../grafiken/seq-1.svg" width="600" alt="Sequenzdiagramm: Login-Ausschnitt mit Aktivierungsbalken"></div>
...
<div style="text-align: center;"><img src="../grafiken/seq-2.svg" width="600" alt="Sequenzdiagramm: synchrone und asynchrone Nachricht im Vergleich"></div>
...
<div style="text-align: center;"><img src="../grafiken/seq-3.svg" width="600" alt="Sequenzdiagramm: Selbstaufruf mit verschachtelten Aktivierungsbalken"></div>
...
<div style="text-align: center;"><img src="../grafiken/seq-4.svg" width="600" alt="Sequenzdiagramm: Objekterzeugung und Objektzerstörung"></div>
...
<div style="text-align: center;"><img src="../grafiken/seq-5.svg" width="600" alt="Sequenzdiagramm: alt-Fragment für eine Verfügbarkeitsprüfung"></div>
...
<div style="text-align: center;"><img src="../grafiken/seq-6.svg" width="600" alt="Sequenzdiagramm: vollständiger Login-Prozess über drei Schichten"></div>
...
<div style="text-align: center;"><img src="../grafiken/seq-7.svg" width="700" alt="Sequenzdiagramm: Bestellprozess mit loop und alt"></div>
...
<div style="text-align: center;"><img src="../grafiken/seq-8.svg" width="650" alt="Sequenzdiagramm: Objekterzeugung und Selbstaufrufe in der Praxis"></div>
