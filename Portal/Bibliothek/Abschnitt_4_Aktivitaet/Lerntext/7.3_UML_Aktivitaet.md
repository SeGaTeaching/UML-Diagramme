...
|---------|--------|--------------|------------|----------|
| **Startknoten** | ⚫ (gefüllter Kreis) | Markiert den Beginn des Prozesses | Jedes Diagramm hat genau einen Startknoten | <img src="../bilder/act-1.svg" width="90"> |
| **Endknoten** | ⊙ (gefüllter Kreis mit Ring) | Markiert das Ende des Prozesses | Ein Diagramm kann mehrere Endknoten haben | <img src="../bilder/act-1.svg" width="90"> |
| **Aktion** | Rechteck mit abgerundeten Ecken | Ein einzelner, atomarer Arbeitsschritt | Sollte ein Verb enthalten (z.B. "Karte eingeben") | <img src="../bilder/act-2.svg" width="90"> |
| **Kontrollfluss** | Pfeil (durchgezogene Linie) | Zeigt die Reihenfolge der Aktionen | Verbindet Aktionen miteinander | <img src="../bilder/act-2.svg" width="90"> |
| **Entscheidungsknoten** | ◊ (Raute) | Verzweigung basierend auf einer Bedingung | Hat einen Eingang, mehrere Ausgänge mit Bedingungen | <img src="../bilder/act-3-1.svg" width="90"> |
| **Zusammenführungsknoten** | ◊ (Raute) | Führt alternative Pfade zusammen | Hat mehrere Eingänge, einen Ausgang (ODER-Logik) | <img src="../bilder/act-3.svg" width="90"> |
| **Fork (Gabelung)** | Dicker schwarzer Balken | Startet parallele Prozesse | Hat einen Eingang, mehrere Ausgänge (UND-Logik) | <img src="../bilder/act-4.svg" width="90"> |
| **Join (Synchronisation)** | Dicker schwarzer Balken | Wartet auf parallele Prozesse | Hat mehrere Eingänge, einen Ausgang (UND-Logik) | <img src="../bilder/act-4.svg" width="90"> |
| **Swimlane** | Vertikale/horizontale Bahn | Zeigt Zuständigkeiten | Unterteilt das Diagramm nach Akteuren/Rollen | <img src="../bilder/act-5.svg" width="90"> |
...
<div style="text-align: center;"><img src="../bilder/act-1.svg" width="400"></div>
...
<div style="text-align: center;"><img src="../bilder/act-2.svg" width="400"></div>
...
<div style="text-align: center;"><img src="../bilder/act-3-1.svg" width="400"></div>

<div style="text-align: center;"><img src="../bilder/act-3.svg" width="400"></div>
...
<div style="text-align: center;"><img src="../bilder/act-4.svg" width="400"></div>
...
<div style="text-align: center;"><img src="../bilder/act-5.svg" width="400"></div>
...
<div style="text-align: center;"><img src="../bilder/act-6.svg" width="400"></div>
...
<div style="text-align: center;"><img src="../bilder/act-7.svg" width="400"></div>
...
<div style="text-align: center;"><img src="../bilder/act-8.svg" width="400"></div>
...
<div style="text-align: center;"><img src="../bilder/act-9.svg" width="400"></div>
...
<div style="text-align: center;"><img src="../bilder/act-10.svg" width="600"></div>
