...
|---|---|---|---|
| Klasse | Rechteck mit drei Bereichen: Name, Attribute, Methoden | `Klassenname` | ![Klasse](../bilder/kls-ref-klasse.svg) |
...
| Vererbung (Generalisierung) | "ist-ein"-Beziehung; Unterklasse erbt von Oberklasse | `Oberklasse <|-- Unterklasse` | ![Vererbung](../bilder/kls-ref-vererbung.svg) |
| Assoziation | "kennt-ein"-Beziehung; allgemeine Verbindung zweier Klassen | `KlasseA --> KlasseB` | ![Assoziation](../bilder/kls-ref-assoziation.svg) |
| Aggregation | lose "hat-ein"-Beziehung; das Teil kann auch ohne das Ganze existieren | `Ganzes o-- Teil` | ![Aggregation](../bilder/kls-ref-aggregation.svg) |
| Komposition | starke "enthält-ein"-Beziehung; das Teil kann nicht ohne das Ganze existieren | `Ganzes *-- Teil` | ![Komposition](../bilder/kls-ref-komposition.svg) |
| Multiplizität (Kardinalität) | Anzahl der beteiligten Objekte an einer Beziehung | `KlasseA "1" -- "0..*" KlasseB` | ![Multiplizität](../bilder/kls-ref-multiplizitaet.svg) |
...
![Drei-Bereiche-Modell einer Klasse](../bilder/kls-01.svg)
...
![Klasse Konto mit Attributen](../bilder/kls-02.svg)
...
![Klasse Konto mit Attributen und Methoden](../bilder/kls-03.svg)
...
![Vererbung: Sparkonto erbt von Konto](../bilder/kls-04.svg)
...
![Zoo-Beispiel mit mehreren Beziehungstypen](../bilder/kls-05.svg)
...
![Assoziation: Fahrer fährt Auto](../bilder/kls-06.svg)
...
![Aggregation: Kunde hat Konto](../bilder/kls-07.svg)
...
![Komposition: Haus besteht aus Raum](../bilder/kls-08.svg)
...
![Gerichtete Assoziation: Kunde kennt Warenkorb](../bilder/kls-17.svg)
...
![Abhängigkeit: Drucker benutzt Dokument](../bilder/kls-18.svg)
...
![Abstrakte Klasse Fahrzeug mit Unterklassen](../bilder/kls-19.svg)
...
![Interface Zahlbar mit Realisierung durch Rechnung und Kunde](../bilder/kls-20.svg)
...
![Übersicht: Welche Beziehung wann?](../bilder/kls-09.svg)

#### Korrekte Pfeile für Klassendiagramme

![Korrekte Pfeile für die vier Beziehungstypen](../bilder/kls-10.svg)
...
![Beispiel mit allen vier Beziehungstypen in einem Diagramm](../bilder/kls-11.svg)

---

## 4. Multiplizitäten: Wie viele Objekte sind beteiligt?

![Übersicht: typische Multiplizitäten im Vergleich](../bilder/kls-12.svg)
...
![Multiplizität: Kunde hat Konto](../bilder/kls-13.svg)
...
![Viele-zu-viele: Student belegt Kurs](../bilder/kls-14.svg)
...
![Eins-zu-null-oder-eins: Person besitzt Reisepass](../bilder/kls-15.svg)
...
![Vollständiges Klassendiagramm des Banksystems](../bilder/kls-16.svg)
